    ...
    'documentations' => [
        'default' => [
            ...
            'paths' => [
                ...
                */
                // Forcer l'URL des assets en HTTPS via APP_URL
                'swagger_ui_assets_path' => env('L5_SWAGGER_UI_ASSETS_PATH', rtrim(env('APP_URL', 'https://gestions-comptes.onrender.com'), '/') . '/docs/asset/'),
